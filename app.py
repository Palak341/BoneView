...
def assist_radiologists_block():
    ...
    .demo-card {
        height: 270px;
        border-radius: 26px;
        background: linear-gradient(180deg, rgba(12,12,14,0.98), rgba(8,8,10,1));
        border: 1px solid rgba(255,255,255,0.06);
        position: relative;
        overflow: hidden;
        padding: 26px;
    ...
    .orb {
        ...
        background: radial-gradient(circle at 35% 35%, #ff4df8, #8b2cf5 58%, #31103f 100%);
    ...
    .typing {
        ...
        width: 0;
        animation: typing 3s steps(12) infinite alternate, blink 0.8s infinite;
    }
    ...
    <div class="wrap">
        <div>
            ...
            <div class="desc">
                Flag potential fracture zones and generate visual overlays to assist radiologists during diagnosis.
            </div>
            <div class="chips">
                <div class="chip">Fracture Map</div>
                <div class="chip">Visual Overlay</div>
                <div class="chip">Annotation</div>
            </div>
        </div>
        ...
        <div class="demo-card">
            ...
            <div class="demo-sub">
                Upload an X-ray to see how our AI highlights fractures in seconds.
            </div>

            <div class="input-box">
                <div class="typing">AI</div>
                <div class="upload-pill">＋ Add X-Ray Image</div>
            </div>

            <div class="bottom-actions">
                <div class="action">📈 Analyze</div>
                <div class="action">🧾 Make Report</div>
            </div>
        </div>
    </div>
    """
...
def remote_diagnosis_block():
    ...
    .screen {
        ...
        height: 300px;
        border-radius: 26px;
        background: linear-gradient(180deg, rgba(10,10,12,0.98), rgba(6,6,8,1));
        border: 1px solid rgba(255,255,255,0.06);
        position: relative;
        overflow: hidden;
        padding: 18px;
    ...
    .scan-box {
        ...
        height: 130px;
        border-radius: 16px;
        background: radial-gradient(circle at center, rgba(217,70,239,0.10), rgba(0,0,0,0.55));
        overflow: hidden;
        display: flex;
        align-items: center;
        justify-content: center;
    ...
    .xray {
        ...
        background:
            ...
            linear-gradient(0deg, transparent 48%, rgba(255,255,255,0.10) 50%, transparent 52%);
    ...
    @keyframes scanMove {
        ...
        100% { transform: translateX(5%) translateY(12px); }
    }
    ...
    <div class="wrap">
        <div class="screen">
            <div class="screen-inner">
                ...
                <div class="tags">
                    <div class="tag">X-ray</div>
                    <div class="tag">Rural Clinic</div>
                    <div class="tag">Help Radiologist</div>
                </div>

                <div class="patient-row">
                    <div>Patient: 19 yrs</div>
                    <div>AI Verified</div>
                </div>

                <div class="patient-row">
                    <div>Region: Rural Clinic</div>
                    <div>Suspected Injury: Shoulder Fracture</div>
                </div>
                ...
                <div class="timeline">
                    <div style="text-align:center;">
                        <div class="dot"></div>
                        <div class="tl-label">Uploaded</div>
                    </div>
                    <div style="text-align:center;">
                        <div class="dot"></div>
                        <div class="tl-label">Detected</div>
                    </div>
                    <div style="text-align:center;">
                        <div class="dot"></div>
                        <div class="tl-label">Overlay</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="right-content">
            ...
            <div class="desc">
                Enable healthcare workers in rural or underserved areas to make accurate decisions without a radiologist present.
            </div>

            <div class="chips">
                <div class="chip">Telemedicine</div>
                <div class="chip">Offline Access</div>
                <div class="chip">Learn More</div>
            </div>
        </div>
    </div>
    """
...
st.markdown(
    '<div class="section-sub">A premium animated workflow section designed in a modern product style — combining medical intelligence, model execution, deployment, and real-time insights.</div>',
    unsafe_allow_html=True
)
...
def medical_data_card():
    ...
    .sweep {
        ...
        background: linear-gradient(135deg, rgba(168,85,247,0.42), transparent 76%);
        animation: rotateSweep 3.5s linear infinite;
    }
